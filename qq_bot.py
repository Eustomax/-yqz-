...
def _abs_url(url: str) -> str:
    """B站动态 jump_url 可能为 //... 相对形式，补全 https: 前缀"""
...
async def dynamic_monitor(qq_bot):
    ...
    def extract_info(item):
        ...
        link = _abs_url(basic.get('jump_url', ''))
        ...
        if major_type == 'MAJOR_TYPE_OPUS':
            ...
            if not link:
                info['link'] = _abs_url(opus.get('jump_url', ''))
        ...
        # 视频
            ...
            if not link:
                info['link'] = _abs_url(archive.get('jump_url', ''))
        ...
        # 专栏
            ...
            if not link:
                info['link'] = _abs_url(article.get('jump_url', ''))
        ...
        # 音频
            ...
            if not link:
                info['link'] = _abs_url(music.get('jump_url', ''))
        ...
        # 绘图/相册（另一种图文形式）
            ...
            if not link:
                info['link'] = _abs_url(draw.get('jump_url', ''))
